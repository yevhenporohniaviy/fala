...
@if(!empty($buttons))
    ...
    <div id="widget-different-therapies">
                            ...
                            <div class="row revers-block">
                                <div class="col-9">
                                    <div class="section-title">
                                        ...
                                        {{ localeContent($button['title']) }}<a href="{{ url($button['isExternal'] ? localeContent($button['externalUrl']) : localizedUrl(localeContent($button['internalUrl']['url']))) }}"
                                                                                target="{{ $button['isExternal'] ? '_blank' : '_self' }}" class="animatePulse"><img
                                ...
                                <div class="col-3 text-center">
                                    <img class="img-fluid" src="{{ url(localeContent($button['img'])) }}">
                                </div>
                            </div>
                        </div>
...
{{--                            <img src="{{ url(localeContent($button['img'])) }}" class="img-fluid mb-5">--}}
