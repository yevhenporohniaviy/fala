...
<script>
  ...
  import DiagnosedSliderPreview from './DiagnosedSliderPreview'
  import DiagnosedSliderEdit from './DiagnosedSliderEdit'

  export default {
    name: 'DiagnosedSliderWidget',
    mixins: [
      mixinWidgets
    ],
    components: {
      DiagnosedSliderEdit,
      DiagnosedSliderPreview
    },
    data () {
      return {
        translateFields: [
