...
<script>
  import SimpleTextGrayPreview
    from './SimpleTextGrayPreview'
  import SimpleTextGrayEdit
    from './SimpleTextGrayEdit'
  import mixinWidgets from '@modules/Core/Assets/mixins/page-builder-widgets'

  export default {
    name: 'SimpleTextGrayWidget',
    mixins: [
      mixinWidgets
    ],
    components: {
      SimpleTextGrayEdit,
      SimpleTextGrayPreview
    },
    props: {
      config: {
        type: [Object, Array],
