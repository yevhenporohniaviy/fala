...
<script>
  ...
  import GetInvolvedPreview from './GetInvolvedPreview'
  import GetInvolvedEdit from './GetInvolvedEdit'

  export default {
    name: 'GetInvolvedWidget',
    mixins: [
      mixinWidgets
    ],
    components: {
